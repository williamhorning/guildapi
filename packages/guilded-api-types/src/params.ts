...
export const pathResolve = {
	...
	'6': [
		...
		['channels', ['{channelId}'], 'topics', ['{forumTopicId}'], 'emotes', [
			'{emoteId}',
		]],
		['channels', ['{channelId}'], 'topics', ['{forumTopicId}'], 'comments', [
			'{forumTopicCommentId}',
		]],
		['servers', ['{serverId}'], 'members', ['{userId}'], 'social-links', [
			'{socialLinkType}',
		]],
		['channels', ['{channelId}'], 'events', ['{calendarEventId}'], 'rsvps', [
			'{userId}',
		...
		['channels', ['{channelId}'], 'events', ['{calendarEventId}'], 'emotes', [
			'{emoteId}',
		]],
		['channels', ['{channelId}'], 'docs', ['{docId}'], 'comments', [
			'{docCommentId}',
...
export const queryParams = {
	'/channels/{channelId}/messages': {
		'get': ['before', 'after', 'limit', 'includePrivate'],
	},
	'/channels/{channelId}/topics': { 'get': ['before', 'limit'] },
	'/channels/{channelId}/docs': { 'get': ['before', 'limit'] },
	'/servers/{serverId}/webhooks': { 'get': ['channelId'] },
	'/channels/{channelId}/events': { 'get': ['before', 'after', 'limit'] },
	'/channels/{channelId}/announcements': { 'get': ['before', 'limit'] },
